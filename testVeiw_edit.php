<html lang="en">
<head>
  <title>ตรวจสถานะ-จัดการข้อสอบ</title>
  <meta charset="utf-8">
            ...
            <div class="panel-body" style="width: 100%; height: 550px; overflow: auto;">
              ...
              while($row = mysqli_fetch_array($result)) {
                ...
                if($status=='ผ่าน') {
                  ...
                  echo "<td><label><a href='testVeiw_edit_del.php?test_id=$row[0]' title='ลบข้อสอบ'
                  ...
                  if($testsend_edit==''){
                    ...
                    echo "<td><label><a href='testVeiw_edit_ed.php?test_id=$row[0]' title='แก้ไขข้อสอบ'>
