  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid ">
      <div class="navbar-header navbar-right">
        <a class="navbar-brand" href="#">&nbsp;CS - COMPREHENSIVE</a>
      </div>
      <ul class="nav navbar-nav">
        ...
        <li class="disabled"><a href="">ตรวจสถานะข้อสอบ</a></l>
      </ul>
            ...
            <div class="panel-body">
              <form action="sendTest_db.php" class="form-horizontal" name="from1" method="post" enctype="multipart/form-data" >
                <br /><div class="form-group">
                  ...
                  <input type="hidden" class="form-control" name="exam_status" value="<?php echo ''; ?>" />
                ...
                <div class="form-group">
                  <div class=" col-sm-12">
                    <button type="submit" class="btn btn-danger col-sm-offset-8 col-md-3"
                    name="uploadExam" style="" value="submit">ยกเลิกส่งข้อสอบ</button>
                  </div>
                </div>
              </form>
              <a href="sendTest.php">
